...
getCurrentFiberStackInDev } from
'./ReactCurrentFiber';
...
shouldDeprioritizeSubtree } from
...
invalidateContextProvider } from
'./ReactFiberContext';
import {
enterHydrationState,
reenterHydrationStateFromDehydratedSuspenseInstance,
resetHydrationState,
tryToClaimNextHydratableInstance } from
...
updateClassInstance } from
'./ReactFiberClassComponent';
import {
readLazyComponentType,
resolveDefaultProps } from
...
isSimpleFunctionComponent } from
'./ReactFiber';
...
function forceUnmountCurrentAndReconcile(current:
...
function updateForwardRef(current:
...
function updateMemoComponent(current:
Fiber | null, workInProgress:
Fiber, Component:
any, nextProps:
any, updateExpirationTime, renderExpirationTime:
...
: null | Fiber {
  ...
  let currentChild = ((current.child as any) as Fiber); // This is always exactly one child
...
function updateSimpleMemoComponent(current:
Fiber | null, workInProgress:
Fiber, Component:
any, nextProps:
any, updateExpirationTime, renderExpirationTime:
...
function updateFragment(current:
Fiber | null, workInProgress:
...
function updateProfiler(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
{
...
function updateClassComponent(current:
Fiber | null, workInProgress:
Fiber, Component:
any, nextProps, renderExpirationTime:
...
function finishClassComponent(current:
Fiber | null, workInProgress:
Fiber, Component:
any, shouldUpdate:
boolean, hasContext:
boolean, renderExpirationTime:
ExpirationTime)
{
...
function updateDehydratedSuspenseComponent(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
{
...
function updatePortalComponent(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
{
...
function updateContextProvider(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
{
...
function updateContextConsumer(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
{
...
function bailoutOnAlreadyFinishedWork(current:
Fiber | null, workInProgress:
Fiber, renderExpirationTime:
ExpirationTime)
: Fiber | null {
