...
export function logError(boundary: Fiber, errorInfo: CapturedValue<unknown>) {
    ...
    case ClassComponent:{
        if (finishedWork.effectTag & Snapshot) {
          if (current !== null) {
            ...
            if (__DEV__) {
              const didWarnSet = ((didWarnAboutUndefinedSnapshotBeforeUpdate as any) as Set<
              unknown>);
