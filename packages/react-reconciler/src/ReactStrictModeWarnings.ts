...
const ReactStrictModeWarnings = {
  discardPendingWarnings(): undefined {},
  flushPendingDeprecationWarnings(): undefined {},
  flushPendingUnsafeLifecycleWarnings(): undefined {},
  recordDeprecationWarnings(fiber: Fiber, instance: any): undefined {},
  recordUnsafeLifecycleWarnings(fiber: Fiber, instance: any): undefined {},
  recordLegacyContextWarning(fiber: Fiber, instance: any): undefined {},
  flushLegacyContextWarning(): undefined {} };
...
if (__DEV__) {
  ...
  ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = () => {
    ((pendingUnsafeLifecycleWarnings as any) as FiberToLifecycleMap).forEach(
  ...
  instance: any) =>
  {
    ...
    if (unsafeLifecycles.length > 0) {
      unsafeLifecycles.forEach(lifecycle => {
        ((warningsForRoot as any) as LifecycleToComponentsMap)[lifecycle].push(
        fiber);
