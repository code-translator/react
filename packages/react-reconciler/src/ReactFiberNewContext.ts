...
export function resetContextDependences(): undefined {
...
export function enterDisallowedContextReadInDEV(): undefined {
  if (__DEV__) {
    isDisallowedContextReadInDEV = true;
  }
}

export function exitDisallowedContextReadInDEV(): undefined {
  if (__DEV__) {
    isDisallowedContextReadInDEV = false;
  }
}

export function pushProvider<T>(providerFiber: Fiber, nextValue: T): undefined {
...
export function popProvider(providerFiber: Fiber): undefined {
...
Fiber | null, renderExpirationTime:
ExpirationTime)
{
...
: T {
  ...
  if (lastContextWithAllBitsObserved === context) {
    ...
    {
      // Observe all updates.
      lastContextWithAllBitsObserved = ((context as any) as ReactContext<unknown>);
    ...
    let contextItem = {
      context: ((context as any) as ReactContext<unknown>),
