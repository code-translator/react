...
import { ReactFragment, ReactPortal, RefObject } from 'shared/ReactTypes';
...
import { ContextDependencyList } from './ReactFiberNewContext';
...
function createFiberFromMode(pendingProps:
any, mode:
TypeOfMode, expirationTime:
ExpirationTime, key:
null | string)
