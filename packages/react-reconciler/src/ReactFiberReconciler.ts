...
findCurrentHostFiberWithNoPortals } from
...
processChildContext,
emptyContextObject,
isContextProvider as isLegacyContextProvider } from
'./ReactFiberContext';
...
current as ReactCurrentFiberCurrent } from
'./ReactCurrentFiber';
...
function findHostInstanceWithWarning(component:
Object, methodName:
string)
: PublicInstance | null {
  if (__DEV__) {
