...
Fiber, Component:
Function, didPushOwnContextIfProvider:
boolean)
: Object {
...
function cacheContext(workInProgress:
Fiber, unmaskedContext:
Object, maskedContext:
Object)
: void {
...
function getMaskedContext(workInProgress:
Fiber, unmaskedContext:
Object)
: Object {
...
function invalidateContextProvider(workInProgress:
Fiber, type:
any, didChange:
boolean)
: void {
