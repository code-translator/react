...
export type Dispatcher = {
  ...
  ReactContext<T>, observedBits:
  undefined | number | boolean) =>
  T;
  useState: <S>(initialState: (() => S) | S) => [S, Dispatch<BasicStateAction<S>>];
  useReducer: <S, I, A>(reducer:
  (a: S, b: A) => S, initialArg:
  I, init:
  (a: I) => S) =>
  [S, Dispatch<A>];
  ...
  Array<unknown> | undefined | null) =>
  void;
  useCallback: <T>(callback: T, deps: Array<unknown> | undefined | null) => T;
  useMemo: <T>(nextCreate: () => T, deps: Array<unknown> | undefined | null) => T;
  useImperativeHandle: <T>(ref:
  {current: T | null;} | ((inst: T | null) => unknown) | null | undefined, create:
  () => T, deps:
  Array<unknown> | undefined | null) =>
  void;
...
type UpdateQueue<S, A> = {
  ...
  lastRenderedReducer: ((a: S, b: A) => S) | null;
...
function warnOnHookMismatchInDev(currentHookName: HookType) {
  if (__DEV__) {
    ...
    ((currentlyRenderingFiber as any) as Fiber).type);
...
function areHookInputsEqual(nextDeps:
Array<unknown>, prevDeps:
Array<unknown> | null)
{
  if (prevDeps === null) {
    if (__DEV__) {
...
export function resetHooks(): undefined {
  // We can assume the previous dispatcher is always this one, since we set it
  // at the beginning of the render phase and there's no re-entrancy.
  ReactCurrentDispatcher.current = ContextOnlyDispatcher;
...
function mountReducer<S, I, A>(reducer:
(a: S, b: A) => S, initialArg:
I, init:
(a: I) => S)
: [S, Dispatch<A>] {
...
function updateReducer<S, I, A>(reducer:
(a: S, b: A) => S, initialArg:
I, init:
(a: I) => S)
: [S, Dispatch<A>] {
...
function mountLayoutEffect(create:
() => (() => void) | void, deps:
Array<unknown> | undefined | null)
: void {
  return mountEffectImpl(
...
function updateLayoutEffect(create:
() => (() => void) | void, deps:
Array<unknown> | undefined | null)
: void {
  return updateEffectImpl(
...
function imperativeHandleEffect<T>(create:
() => T, ref:
{current: T | null;} | ((inst: T | null) => unknown) | null | undefined)
{
...
function mountImperativeHandle<T>(ref:
{current: T | null;} | ((inst: T | null) => unknown) | null | undefined, create:
() => T, deps:
Array<unknown> | undefined | null)
: void {
...
function updateImperativeHandle<T>(ref:
{current: T | null;} | ((inst: T | null) => unknown) | null | undefined, create:
() => T, deps:
Array<unknown> | undefined | null)
: void {
...
function mountDebugValue<T>(value: T, formatterFn: (value: T) => unknown | null | undefined): void {
...
function mountCallback<T>(callback: T, deps: Array<unknown> | undefined | null): T {
  const hook = mountWorkInProgressHook();
  const nextDeps = deps === undefined ? null : deps;
...
function updateCallback<T>(callback: T, deps: Array<unknown> | undefined | null): T {
  const hook = updateWorkInProgressHook();
  const nextDeps = deps === undefined ? null : deps;
...
function mountMemo<T>(nextCreate:
() => T, deps:
Array<unknown> | undefined | null)
: T {
  const hook = mountWorkInProgressHook();
...
function updateMemo<T>(nextCreate:
() => T, deps:
Array<unknown> | undefined | null)
: T {
  const hook = updateWorkInProgressHook();
...
function dispatchAction<S, A>(fiber:
Fiber, queue:
UpdateQueue<S, A>, action:
A)
{
  invariant(
...
if (__DEV__) {
  ...
  HooksDispatcherOnMountInDEV = {
    ...
    observedBits: undefined | number | boolean)
    : T {
    ...
    useEffect(
    create: () => (() => void) | void,
    deps: Array<unknown> | undefined | null)
    : undefined {
    ...
    ref: {current: T | null;} | ((inst: T | null) => unknown) | null | undefined,
    create: () => T,
    deps: Array<unknown> | undefined | null)
    : undefined {
    ...
    useMemo<T>(create: () => T, deps: Array<unknown> | undefined | null): T {
    ...
    useDebugValue<T>(value: T, formatterFn: (value: T) => unknown | null | undefined): undefined {
