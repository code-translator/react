...
export function recordEffect(): undefined {
  if (enableUserTimingAPI) {
    effectCountInCurrentCommit++;
  }
}

export function recordScheduleUpdate(): undefined {
  if (enableUserTimingAPI) {
    if (isCommitting) {
...
export function startRequestCallbackTimer(): undefined {
  if (enableUserTimingAPI) {
...
export function startWorkTimer(fiber: Fiber): undefined {
  if (enableUserTimingAPI) {
...
export function cancelWorkTimer(fiber: Fiber): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming || shouldIgnoreFiber(fiber)) {
      return;
    }
...
export function stopWorkTimer(fiber: Fiber): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming || shouldIgnoreFiber(fiber)) {
      return;
    }
...
export function stopFailedWorkTimer(fiber: Fiber): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming || shouldIgnoreFiber(fiber)) {
      return;
    }
...
export function startPhaseTimer(fiber: Fiber, phase: MeasurementPhase): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function stopPhaseTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function startWorkLoopTimer(nextUnitOfWork: Fiber | null): undefined {
  if (enableUserTimingAPI) {
...
export function startCommitTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function stopCommitTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function startCommitSnapshotEffectsTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function stopCommitSnapshotEffectsTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function startCommitHostEffectsTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function stopCommitHostEffectsTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function startCommitLifeCyclesTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
...
export function stopCommitLifeCyclesTimer(): undefined {
  if (enableUserTimingAPI) {
    if (!supportsUserTiming) {
      return;
    }
