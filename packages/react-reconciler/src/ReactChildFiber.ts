...
function coerceRef(returnFiber:
  Fiber, current:
  Fiber | null, element:
  ReactElement) {
  ...
  if (
    ...
    if (element._owner) {
      const owner: Fiber | null | undefined = (element._owner as any);
      let inst;
      if (owner) {
...
function ChildReconciler(shouldTrackSideEffects) {
  function deleteChild(returnFiber: Fiber, childToDelete: Fiber): undefined {
  ...
  function mapRemainingChildren(
    returnFiber: Fiber,
    currentFirstChild: Fiber): Map < string | number, Fiber > {
  ...
  function createChild(
    returnFiber: Fiber,
    newChild: any,
    expirationTime: ExpirationTime): Fiber | null {
  ...
  function warnOnInvalidKey(
    child: unknown,
    knownKeys: Set < string > | null): Set < string > | null {
    if (__DEV__) {
