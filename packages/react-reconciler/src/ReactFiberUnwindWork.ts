...
popTopLevelContextObject as popTopLevelLegacyContextObject } from
'./ReactFiberContext';
...
function createRootErrorUpdate(fiber:
Fiber, errorInfo:
CapturedValue<unknown>, expirationTime:
ExpirationTime)
: Update<unknown> {
...
function createClassErrorUpdate(fiber:
Fiber, errorInfo:
CapturedValue<unknown>, expirationTime:
ExpirationTime)
: Update<unknown> {
...
function attachPingListener(root:
FiberRoot, renderExpirationTime:
ExpirationTime, thenable:
Thenable)
{
...
function throwException(root:
FiberRoot, returnFiber:
Fiber, sourceFiber:
Fiber, value:
unknown, renderExpirationTime:
ExpirationTime)
{
