...
restoreControlledState as ReactDOMInputRestoreControlledState } from
'./ReactDOMInput';
import {
getHostProps as ReactDOMOptionGetHostProps,
postMountWrapper as ReactDOMOptionPostMountWrapper,
validateProps as ReactDOMOptionValidateProps } from
'./ReactDOMOption';
import {
...
postUpdateWrapper as ReactDOMSelectPostUpdateWrapper } from
'./ReactDOMSelect';
import {
...
restoreControlledState as ReactDOMTextareaRestoreControlledState } from
'./ReactDOMTextarea';
...
TOP_SUBMIT,
TOP_TOGGLE } from
'../events/DOMTopLevelEventTypes';
import { listenTo, trapBubbledEvent } from '../events/ReactBrowserEventEmitter';
import { mediaEventTypes } from '../events/DOMTopLevelEventTypes';
import {
createDangerousStringForStyles,
setValueForStyles,
validateShorthandPropertyCollisionInDev } from
'../shared/CSSPropertyOperations';
import { Namespaces, getIntrinsicNamespace } from '../shared/DOMNamespaces';
import {
getPropertyInfo,
shouldIgnoreAttribute,
shouldRemoveAttribute } from
'../shared/DOMProperty';
...
string, domElement:
Element, rootContainerElement:
Element | Document, nextProps:
...
function updateDOMProperties(domElement:
Element, updatePayload:
Array<any>, wasCustomComponentTag:
boolean, isCustomComponentTag:
boolean)
: void {
