...
warnForInsertedHydratedText } from
'./ReactDOMComponent';
...
setEnabled as ReactBrowserEventEmitterSetEnabled } from
'../events/ReactBrowserEventEmitter';
...
unstable_cancelCallback as cancelDeferredCallback } from
'scheduler';
...
let selectionInformation: unknown | null | undefined = null;
...
export function prepareForCommit(containerInfo: Container): undefined {
  eventsEnabled = ReactBrowserEventEmitterIsEnabled();
  selectionInformation = getSelectionInformation();
  ReactBrowserEventEmitterSetEnabled(false);
}

export function resetAfterCommit(containerInfo: Container): undefined {
...
export function resetTextContent(domElement: Instance): undefined {
...
export function hideInstance(instance: Instance): undefined {
...
export function hideTextInstance(textInstance: TextInstance): undefined {
  textInstance.nodeValue = '';
}

export function unhideInstance(instance: Instance, props: Props): undefined {
  instance = ((instance as any) as HTMLElement);
