...
let currentHookNameInDev: string | null | undefined;
...
export function prepareToUseHooks(componentIdentity: Object): undefined {
...
function readContext<T>(context:
...
function useMemo<T>(nextCreate: () => T, deps: Array<unknown> | undefined | null): T {
  currentlyRenderingComponent = resolveCurrentlyRenderingComponent();
  workInProgressHook = createWorkInProgressHook();
...
create: () => (() => void) | void,
inputs: Array<unknown> | undefined | null)
{
  if (__DEV__) {
...
function dispatchAction<A>(componentIdentity:
Object, queue:
UpdateQueue<A>, action:
A)
{
  invariant(
